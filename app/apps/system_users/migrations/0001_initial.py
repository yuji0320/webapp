    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_login_user', models.BooleanField(default=True, help_text='Designates whether the user can create login user.', verbose_name='login status')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created time')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='updated time')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='system_users.UserCompany')),
            ],
            options={
                'verbose_name': 'staff',
