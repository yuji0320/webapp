  ...
  computed: {
    ...
    tableData() {
      if(this.jobOrder) {
        ...
        let outsourcingMechanicalDesignBudget = defaultDisplay + this.moneyComma(this.jobOrder.outsourcingMechanicalDesignBudget);
        let outsourcingElectricalDesignBudget = defaultDisplay + this.moneyComma(this.jobOrder.outsourcingElectricalDesignBudget);
        let outsourcingOtherBudget = defaultDisplay + this.moneyComma(this.jobOrder.outsourcingOtherBudget);
